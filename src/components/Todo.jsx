...
const Todo = () => {
  return (
    <div className='bg-white place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[750px] rounded-2xl'>
...
{/*------------input----------------*/}
    <div className='flex items-center my-7 bg-gray-100 rounded-full'>
        <input className='bg-transparent border-0 outline-none flex-1 h-14 pl-6 pr-2 placeholder:text-slate-600' type="text" placeholder='Add a new task'/>
